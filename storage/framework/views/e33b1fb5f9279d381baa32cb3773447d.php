                 ...
                 <div class="row">
                     <div class="col-lg-3 col-md-6 col-sm-6">
                         <div class="footer_widget">
                             <h3>About us</h3>
                             <p>Thời trang mang đến sự tự tin</p>
                             <div class="footer_widget_contect">
                                 <p><i class="fa fa-map-marker" aria-hidden="true"></i> 336/32/6 Dương Quảng Hàm - Gò Vấp</p>

                                 <p><i class="fa fa-mobile" aria-hidden="true"></i> 0326748389</p>
                                 <a href="#"><i class="fa fa-envelope-o" aria-hidden="true"></i> bvphuc2000$@gmail.com </a>
                             </div>
                         </div>
                     </div>
                     <div class="col-lg-3 col-md-6 col-sm-6">
                 ...
                 <div class="row align-items-center">
                     <div class="col-lg-6 col-md-6">
                         <div class="copyright_area">
                             ...
                             <p>Copyright &copy; 2024 <a href="#">Ps33476</a> </p>
                         </div>
                     </div>
                     <div class="col-lg-6 col-md-6">
     ...
     <script src="<?php echo e(asset('assets/js/my.js')); ?>"></script>
     </body>

     </html><?php /**PATH C:\xampp\htdocs\asm-laravel-main\resources\views/footer.blade.php ENDPATH**/ ?>