            ...
            <div class="pos_page">
                <div class="container">
                    ...
                    <div class="pos_page_inner">
                                    ...
                                    <div class="col-lg-6 col-md-6">
                                        <div class="header_links">
                                            <ul>
                                                ...
                                                <li><a href="<?php echo e(route('myaccount')); ?>" title="My account"><b>Chào</b>, <?php echo e(Auth::user()->username); ?></a></li>
                                                <li><a href="<?php echo e(route('cart')); ?>" title="My cart">My cart</a></li>
                                                <?php endif; ?>
                                                <?php if(auth()->guard()->guest()): ?>
                                                <li><a href="<?php echo e(route('loginForm')); ?>" title="Login">Login</a></li>
                                                <?php endif; ?>
                                            </ul>
                                        </div>
                                    </div>
                            ...
                            <div class="header_middel">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-lg-3 col-md-3">
                                        <div class="logo">
                                            <a href="<?php echo e(route('home')); ?>"><img src="assets\img\logo\logo.jpg.png" alt=""></a>
                                        </div>
                                    </div>
                                    <!--logo end-->
                                            ...
                                            <div class="main_menu d-none d-lg-block">
                                                <nav>
                                                    <ul>
                                                        ...
                                                        <li><a href="<?php echo e(route('products')); ?>">shop</a>
                                                            <!-- <div class="mega_menu jewelry">
                                                                <div class="mega_items jewelry">
                                                                    <ul>
                        ...
                        <!--header end --><?php /**PATH C:\xampp\htdocs\asm-laravel-main\resources\views/header.blade.php ENDPATH**/ ?>